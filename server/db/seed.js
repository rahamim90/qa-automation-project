  ...
  const barbers = [
    {
      name: 'יוסי כהן',
      slug: 'yossi-cohen',
      bio: 'יוסי הוא האח הגדול של המספרה - 15 שנה בתחום ועדיין הכי מגניב בחדר. הקלאסיקות שלו זה כמו רקורד ישן: לא צריך לשדרג, כי הן כבר מושלמות. תבואו לספר לו סיפור, לצאת עם פייד נקי, ולגלות שהוא מכיר כל שיר טוב מ-Fresh Prince ועד Burna Boy.',
      specialty: 'קלאסיקות בלי פשרות + זקן שנראה כאילו נולד ככה',
    ...
    },
    {
      name: 'דניאל לוי',
      slug: 'daniel-levi',
      bio: 'דניאל זה הדור הצעיר של המספרה - קווים חדים כמו הבס בפלייליסט שלו. הוא גדל על אפרו-ביטס והיפ-הופ, ומביא בדיוק את אותה אנרגיה לכל תספורת: מדויק, עדכני, ותמיד עם הפתעה קטנה בסוף.',
      specialty: 'פייד שמדבר בעד עצמו + סטייל שמתעדכן כל שבוע',
    ...
    },
    {
      name: 'אבי מזרחי',
      slug: 'avi-mizrahi',
      bio: 'אבי הוא הלב החם של הצוות - הכי סבלני עם הילדים, הכי בטוח עם התער, והכי טוב בסיפורים בזמן שמחכים לתור. גם אם הגעתם עצבניים, יוצאים מפה מחייכים (ועם תספורת מושלמת).',
      specialty: 'תער בלי רעד + תספורות ילדים בלי דמעות',
